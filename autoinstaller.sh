...
DEFAULT_PACMAN_PKGS=("base-devel" "git" "pkgconf" "libx11" "dkms" "kmod" "bash" "util-linux")
DEFAULT_TINYCORE_PKGS=("bash" "binutils" "coreutils" "make" "gcc" "git" "patch" "grep" "sed" "linux-headers" "pkgconf" "kmod" "dkms" "which")
